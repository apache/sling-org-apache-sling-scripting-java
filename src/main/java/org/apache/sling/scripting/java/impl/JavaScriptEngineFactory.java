 ...
 */
@Component(
        service = {javax.script.ScriptEngineFactory.class, ResourceChangeListener.class},
        property = {
...
public class JavaScriptEngineFactory extends AbstractScriptEngineFactory
    ...
    protected void activate(final Config config, final Map<String, Object> props) {
        ...
        this.javaServletContext = new JavaServletContext(ioProvider, slingServletContext);
    ...
    private void callServlet(
            final Bindings bindings, final SlingScriptHelper scriptHelper, final ScriptContext context) {
