...
public class CompilationUnit implements org.apache.sling.commons.compiler.CompilationUnitWithSource {

    private final SlingIOProvider ioProvider;
    private final String className;
    private final String sourceFile;

    public CompilationUnit(final String sourceFile, final String className, final SlingIOProvider ioProvider) {
